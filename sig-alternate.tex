...
\begin{table}[]
\centering
\caption{Imutable programming features in different languages}
\label{my-label}
\begin{tabular}{|l|l|}
\hline
\multicolumn{2}{|c|}{Immutable}                                                                                                                          \\ \hline
Scala  & val maxValue = 100                                                                                                                              \\ \hline
Swift  & let (firstNumber, secondNumber) = (10, 42)                                                                                                      \\ \hline
Falcon & -                                                                                                                                               \\ \hline
F\#    & -                                                                                                                                               \\ \hline
Rust   & const mut acc = 1                                                                                                                               \\ \hline
Vb.net & const PI = 1                                                                                                                                    \\ \hline
C\#    & const PI = 3.14149                                                                                                                              \\ \hline
D      & imutable int len = 1                                                                                                                            \\ \hline
Oz     & -                                                                                                                                               \\ \hline
Matlab & \begin{tabular}[c]{@{}l@{}}function h = planck \% Planck's constant. \\ h = 6.626068e-34; \% Units are m\textasciicircum{}2 kg / s\end{tabular} \\ \hline
R      & a \textless{}- 1 lockBinding("a", globalenv())                                                                                                  \\ \hline
Python & class Foo(object): CONST\_NAME = "Name"                                                                                                         \\ \hline
\end{tabular}
\end{table}
...
\hline
%\multicolumn{2}{|c|}{Imperative control}                     \\ \hline
